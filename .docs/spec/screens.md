...
**現在の状態**: Coming Soon（準備中）

投影予約機能は近日公開予定です。現在は「準備中」メッセージを表示し、トップページへのリンクを提供しています。
...
| 機能 | 説明 |
|------|------|
| 一覧表示 | カテゴリ別タブ（背景/窓/車輪/音楽） |
| 新規作成 | タイトル/動画URL/サムネイルURL/カテゴリ |
| 編集 | タイトル/動画URL/サムネイルURL |
| 有効化/無効化 | is_activeフラグの切り替え |
| 削除 | テンプレートの削除 |
